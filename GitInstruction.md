...
Система контроля версий позволяет отслеживать историю изменений файлов, создавать комиты для более удобного ориентирования в истории изменеий..
        Строится через систему создания локальный репозиториев, которым в дальнейшем можно делиться с другими участниками группы.
        Благодяра комитам и веткам в системе контроля версии мы можем не затрагивая текущую "сборку" вносить правки и добавлять функционал используя команны Commit/branch "name"/checkout/pull всеми участниками работы./-
