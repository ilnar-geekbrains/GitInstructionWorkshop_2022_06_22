...
Совместная работа в системах контроля версий строится на совместном использовании репозитория, внесении правок.

Нужна для групповой работы над документом.
