...
**git branch new_name_branch** -- позволяет создать новую ветку. Для этого введите *git branch* затем *имя* новой ветки.

**git checkout** -- позволяет переключаться между ветками, для этого после ввода команды введите *имя* нужной вам ветки *через пробел*
