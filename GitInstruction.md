...
Это система (инструмент), позволяющая отслеживать и фиксировать изменения (версии) файла с возможностью перерехода и работой с любой из версий данного файла
