...
3. Подружить локальный и уадлённый репозиторий 
4. Отправить (push) локальный репозиториий в удалёный (GitHub)
5. Проверсти изменения с другого компьютера 
6. Выкачать (pull) актуальное состояние из удалённого репозитория 


Команда "push" отправляет данные с локальной репозитория на ваш удалённый на сайте GitHub

Команда "pull" синхронизирует ваши репозитории,если вы его изменяли не у себя,на сайте или на другом компьютере 
