...
3. Командой "git init" инициализировать репозиторий в данной папке
4. Командой "git status" проверить статус
5. Создать новый файл в репозитории
6. Начать работу с файлом
