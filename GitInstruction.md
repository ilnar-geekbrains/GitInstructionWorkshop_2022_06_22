...
1. В окне терминала ввести  git --version, если git не установлен, то вам будет предложено его установить
2. Более новую версию можно скачать по [ссылке](https://git-scm.com/download/mac)
3. Установливаем следуя инструкциям установщика
4. Запускаем VSCode и проверяем работу
5. Радуемся жизни. 
