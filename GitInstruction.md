...
2. Делаем git clone "форкнутого" репозитория на локальный ПК
3. Изменения принято делать в новой ветке
4. Создаём новую ветку
5. Вносим изменения
6. Создаэм коммит
7. Отправляем изменения git push
8. Отправляем pull request владельцу "форкнутого репозитория"
